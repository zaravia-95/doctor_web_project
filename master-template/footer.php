							...
							<div class="dc-footer-call-email">
								<div class="dc-callinfoholder">
									<figure class="dc-callinfoimg">
										<img src="doclist/images/footer/img-01.png" alt="img description">
									</figure>
								...
								<div class="dc-callinfoholder dc-mailinfoholder">
									<figure class="dc-callinfoimg">
										<img src="doclist/images/footer/img-02.png" alt="img description">
									</figure>
									<div class="dc-callinfocontent">
					...
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 float-left">
							<div class="dc-fcol dc-widgetcontactus">
								<strong class="dc-logofooter"><a href="index-2.html"><img src="doclist/images/flogo.png" alt="company logo here"></a></strong>
									...
									<ul class="dc-livefeeddetails">
										<li>
											<figure class="dc-latestadimg">
												<img src="doclist/images/footer/img-03.png" alt="img description">
											</figure>
										...
										<li>
											<figure class="dc-latestadimg">
												<img src="doclist/images/footer/img-04.png" alt="img description">
											</figure>
											<div class="dc-latestadcontent">
							...
							<div class="dc-fcol dc-newsletterholder">
								...
								<div class="dc-footercontent dc-newsletterholder">
									...
									<div class="dc-footerapps">
										...
										<ul class="dc-btnapps">
											<li><a href="javascript:void(0)"><img src="doclist/images/footer/img-05.png" alt="img description"></a></li>
											<li><a href="javascript:void(0)"><img src="doclist/images/footer/img-06.png" alt="img description"></a></li>
										</ul>
									</div>
								</div>
							</div>
					...
					<div class="container">
						<div class="row">
							<div class="col-12 col-sm-12">
								<p class="dc-copyright">Copyrights © 2019 by <span>DocList.</span> All Rights Reserved.</p>
							</div>
						</div>
					</div>
				</div>
	...
	<script src="doclist/js/moment.min.js"></script>
	<script src="doclist/js/fullcalendar.min.js"></script>
	<script src="doclist/js/owl.carousel.min.js"></script>
	<script src="doclist/js/chosen.jquery.js"></script>
	<script src="doclist/js/scrollbar.min.js"></script>
	<script src="doclist/js/jquery-ui.js"></script>
	<script src="doclist/js/prettyPhoto.js"></script>
	<script src="doclist/js/jquery-ui.js"></script>
	<script src="doclist/js/slick.min.js"></script>
	<script src="doclist/js/appear.js"></script>
